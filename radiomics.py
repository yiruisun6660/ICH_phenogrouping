...
# Calulating hemorrhage volumes
hounfield_units_per_mm = 1  # Assuming 1 mm per HU for simplicity
voxel_size = 3  # mm
hemorrhage_volume_mm3 = np.sum(mask.GetBuffer() == 1) * voxel_size**3
...
print(f"Calculated hemorrhage volume: {hemorrhage_volume_mm3} mm^3")